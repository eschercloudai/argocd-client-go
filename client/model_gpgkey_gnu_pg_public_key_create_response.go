...
// checks if the GpgkeyGnuPGPublicKeyCreateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GpgkeyGnuPGPublicKeyCreateResponse{}
