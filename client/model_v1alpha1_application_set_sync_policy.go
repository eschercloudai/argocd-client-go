...
// checks if the V1alpha1ApplicationSetSyncPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1alpha1ApplicationSetSyncPolicy{}
...
func (o *V1alpha1ApplicationSetSyncPolicy) GetPreserveResourcesOnDeletion() bool {
	if o == nil || isNil(o.PreserveResourcesOnDeletion) {
		var ret bool
		return ret
	}
...
func (o V1alpha1ApplicationSetSyncPolicy) ToMap() (map[string]interface{}, error) {
	...
	if !isNil(o.PreserveResourcesOnDeletion) {
