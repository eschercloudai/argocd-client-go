...
// checks if the V1alpha1ResourceOverride type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1alpha1ResourceOverride{}
...
func (o *V1alpha1ResourceOverride) GetIgnoreDifferences() V1alpha1OverrideIgnoreDiff {
	if o == nil || isNil(o.IgnoreDifferences) {
...
func (o *V1alpha1ResourceOverride) GetKnownTypeFields() []V1alpha1KnownTypeField {
	if o == nil || isNil(o.KnownTypeFields) {
