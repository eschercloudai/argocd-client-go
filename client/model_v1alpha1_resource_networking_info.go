...
// checks if the V1alpha1ResourceNetworkingInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1alpha1ResourceNetworkingInfo{}
...
func (o V1alpha1ResourceNetworkingInfo) ToMap() (map[string]interface{}, error) {
	...
	if !isNil(o.TargetLabels) {
		toSerialize["targetLabels"] = o.TargetLabels
	}
	if !isNil(o.TargetRefs) {
