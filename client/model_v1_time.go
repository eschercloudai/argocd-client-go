...
// checks if the V1Time type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1Time{}
...
func (o V1Time) ToMap() (map[string]interface{}, error) {
