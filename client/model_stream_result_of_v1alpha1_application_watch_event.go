...
// checks if the StreamResultOfV1alpha1ApplicationWatchEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamResultOfV1alpha1ApplicationWatchEvent{}
