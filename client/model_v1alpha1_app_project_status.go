...
// checks if the V1alpha1AppProjectStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1alpha1AppProjectStatus{}
...
func (o *V1alpha1AppProjectStatus) GetJwtTokensByRole() map[string]V1alpha1JWTTokens {
	if o == nil || isNil(o.JwtTokensByRole) {
