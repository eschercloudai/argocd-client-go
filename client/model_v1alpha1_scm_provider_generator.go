...
// checks if the V1alpha1SCMProviderGenerator type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1alpha1SCMProviderGenerator{}
...
func (o *V1alpha1SCMProviderGenerator) GetBitbucketServer() V1alpha1SCMProviderGeneratorBitbucketServer {
	if o == nil || isNil(o.BitbucketServer) {
...
func (o *V1alpha1SCMProviderGenerator) GetCloneProtocol() string {
	if o == nil || isNil(o.CloneProtocol) {
		var ret string
		return ret
	}
