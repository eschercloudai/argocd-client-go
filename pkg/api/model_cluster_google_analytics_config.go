...
// checks if the ClusterGoogleAnalyticsConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterGoogleAnalyticsConfig{}
