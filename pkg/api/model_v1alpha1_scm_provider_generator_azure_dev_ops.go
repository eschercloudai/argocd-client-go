...
// checks if the V1alpha1SCMProviderGeneratorAzureDevOps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1alpha1SCMProviderGeneratorAzureDevOps{}
...
func (o *V1alpha1SCMProviderGeneratorAzureDevOps) GetAccessTokenRef() V1alpha1SecretRef {
	if o == nil || isNil(o.AccessTokenRef) {
