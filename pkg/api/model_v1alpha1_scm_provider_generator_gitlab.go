...
// checks if the V1alpha1SCMProviderGeneratorGitlab type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1alpha1SCMProviderGeneratorGitlab{}
...
func (o *V1alpha1SCMProviderGeneratorGitlab) GetIncludeSubgroups() bool {
	if o == nil || isNil(o.IncludeSubgroups) {
		var ret bool
		return ret
	}
