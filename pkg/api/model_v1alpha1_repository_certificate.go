...
// checks if the V1alpha1RepositoryCertificate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1alpha1RepositoryCertificate{}
