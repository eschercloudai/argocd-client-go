...
// checks if the ApplicationApplicationSyncWindow type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationApplicationSyncWindow{}
