...
// checks if the RepositoryRepoAppDetailsQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RepositoryRepoAppDetailsQuery{}
