...
// checks if the V1alpha1HostInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1alpha1HostInfo{}
...
func (o *V1alpha1HostInfo) GetResourcesInfo() []V1alpha1HostResourceInfo {
	if o == nil || isNil(o.ResourcesInfo) {
