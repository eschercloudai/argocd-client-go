...
// checks if the ApplicationsetApplicationSetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationsetApplicationSetResponse{}
...
func (o *ApplicationsetApplicationSetResponse) GetApplicationset() V1alpha1ApplicationSet {
	if o == nil || isNil(o.Applicationset) {
