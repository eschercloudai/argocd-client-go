...
// checks if the V1alpha1ApplicationSourceKustomize type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1alpha1ApplicationSourceKustomize{}
...
func (o *V1alpha1ApplicationSourceKustomize) GetCommonAnnotations() map[string]string {
	if o == nil || isNil(o.CommonAnnotations) {
...
func (o *V1alpha1ApplicationSourceKustomize) GetForceCommonAnnotations() bool {
	if o == nil || isNil(o.ForceCommonAnnotations) {
		var ret bool
		return ret
	}
...
func (o *V1alpha1ApplicationSourceKustomize) GetForceCommonLabels() bool {
	if o == nil || isNil(o.ForceCommonLabels) {
		var ret bool
		return ret
	}
